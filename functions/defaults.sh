...
function write_defaults {
  ...
  # this prevents them from overriding settings we are about to change
  osascript -e 'tell application "System Preferences" to quit'

  # Ask for the administrator password upfront
  sudo -v

  # Keep-alive: update existing `sudo` time stamp until script has completed
  ...
  # Reveal IP address, hostname, OS version, et cetetra
  ...
  # Set spell checker to automatically identifies languages
  ...
  # Decrease the standard delay in rendering a web pages
  ...
  # Automatically update extensions installed through the Safari extension gallery
  ...
  echo "Done. Note that some changes require a restart to take effect."
}

export -f write_defaults
